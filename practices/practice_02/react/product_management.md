...
Feature: Review diff and return structured findings
  ...
  Scenario: Негативный или граничный размер
  ...
  Scenario: Негативный — таймаут внешнего LLM
    ...
    When пользователь отправляет POST /api/reviews с этим diff
    Then система возвращает контролируемую ошибку
...
- Что проверили и исправили сами: Уточнён негативный сценарий по REL-1; структура и ссылки проверены.
